...
(define-public (liquidate
  ...
  (let (
    ...
    (let (
        ...
        (pool-deposits (contract-call? .stability-pool-v5 get-total-deposits stablecoin-id))
        (reward-pct (contract-call? .stability-pool-v5 get-liquidation-reward-pct stablecoin-id))
      )
      ...
      (let (
        ...
        (try! (contract-call? .multi-asset-vault-engine-v6 liquidate-position
        ...
        (try! (contract-call? .stability-pool-v5 distribute-liquidation-reward
