...
(define-private (get-asset-config (asset principal))
  (contract-call? .collateral-registry-v4 get-collateral-config asset)
)

(define-private (get-asset-config-for-stablecoin (stablecoin-id uint) (asset principal))
  (contract-call? .collateral-registry-v4 get-effective-collateral-config stablecoin-id asset)
)

(define-private (get-min-ratio-for-asset (asset principal))
  (default-to u150 (contract-call? .collateral-registry-v4 get-min-collateral-ratio asset))
)

(define-private (get-min-ratio-for-stablecoin-asset (stablecoin-id uint) (asset principal))
  (default-to u150 (contract-call? .collateral-registry-v4 get-effective-min-collateral-ratio stablecoin-id asset))
)

(define-private (get-liquidation-ratio-for-asset (asset principal))
  (default-to u120 (contract-call? .collateral-registry-v4 get-liquidation-ratio asset))
)

(define-private (get-liquidation-ratio-for-stablecoin-asset (stablecoin-id uint) (asset principal))
  (default-to u120 (contract-call? .collateral-registry-v4 get-effective-liquidation-ratio stablecoin-id asset))
)
              ...
              config
                (begin
                  ...
                  (let (
                    ...
                    (try! (contract-call? .collateral-registry-v4 increase-stablecoin-debt stablecoin-id asset amount))
              ...
              config
                (begin
                  ...
                  (let (
                    ...
                    (try! (contract-call? .collateral-registry-v4 decrease-stablecoin-debt stablecoin-id asset amount))
        ...
        (match (map-get? vault-collateral {owner: owner, stablecoin-id: stablecoin-id, asset: asset})
          position
            (begin
              ...
              (try! (contract-call? .collateral-registry-v4 decrease-stablecoin-debt stablecoin-id asset debt-to-offset))
              ;; Transfer seized collateral to stability pool
              (try! (as-contract (contract-call? collateral-token transfer collateral-to-seize tx-sender .stability-pool-v4)))
              ;; Burn stablecoins from stability pool's balance
              (try! (contract-call? stablecoin-token burn debt-to-offset .stability-pool-v4))
